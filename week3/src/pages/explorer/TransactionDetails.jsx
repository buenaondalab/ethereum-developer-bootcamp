    ...
    return (
        ...
        >
            <Box sx={{
                ...
                <Typography variant="h5" textAlign={'left'} noWrap>{tx ? tx.hash : '<- Select a transaction in the list'}</Typography>
                <Typography variant="h5" textAlign={'right'} sx={{flex: 1}}>Transaction Details</Typography>
            </Box>
            {tx && <Box sx={{height: '750px', overflow: 'auto'}}>
                ...
                <Paper sx={{paddingX: 2}} elevation={2}><Typography variant="subtitle1" noWrap>Data: {tx.data}</Typography></Paper>
                ...
                <Paper sx={{paddingX: 2}} elevation={2}><Typography variant="subtitle1" noWrap>Gas limit: {tx.gasLimit} units</Typography></Paper>
                <Paper sx={{paddingX: 2}} elevation={2}><Typography variant="subtitle1" noWrap>Gas price: {tx.gasPrice ? Utils.formatUnits(tx.gasPrice, 'gwei') : '-'}</Typography></Paper>
                <Divider />
